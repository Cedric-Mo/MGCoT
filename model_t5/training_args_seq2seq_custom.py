...
from .training_args_custom import CustomTrainingArguments
...
@dataclass
@add_start_docstrings(CustomTrainingArguments.__doc__)
class CustomSeq2SeqTrainingArguments(CustomTrainingArguments):
    """
